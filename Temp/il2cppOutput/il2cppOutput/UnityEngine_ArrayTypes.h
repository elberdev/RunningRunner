...
// UnityEngine.iOS.LocalNotification[]
struct LocalNotificationU5BU5D_t444251449  : public Il2CppArray
{
public:
	ALIGN_TYPE (8) LocalNotification_t3128840488 * m_Items[1];

public:
	inline LocalNotification_t3128840488 * GetAt(il2cpp_array_size_t index) const { return m_Items[index]; }
	inline LocalNotification_t3128840488 ** GetAddressAt(il2cpp_array_size_t index) { return m_Items + index; }
	inline void SetAt(il2cpp_array_size_t index, LocalNotification_t3128840488 * value)
	{
		m_Items[index] = value;
		Il2CppCodeGenWriteBarrier(m_Items + index, value);
	}
