...
struct  GK_TurnBasedParticipantStatus_t4233723594 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(GK_TurnBasedParticipantStatus_t4233723594, ___value___1)); }
